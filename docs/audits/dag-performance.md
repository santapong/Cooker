...
**See also:** [`spof-and-database.md`](spof-and-database.md), [`crash-and-service-quality.md`](crash-and-service-quality.md), [`vulnerabilities-and-chains.md`](vulnerabilities-and-chains.md), and [`remediation-plan.md`](remediation-plan.md) — the phased plan to fix everything in the four audit docs.
